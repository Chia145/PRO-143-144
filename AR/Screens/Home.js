...
import { StyleSheet, Text, View, Image, TouchableOpacity, TouchableNativeFeedback, Pressable } from 'react-native';
import {RFValue} from 'react-native-responsive-fontsize';
import axios from "axios";
import { Header, Icon, Card, AirbnbRating} from 'react-native-elements';
...
getArticle = () => {
    const url = 'http://3a9b-2402-e280-3d6b-7e-3138-6a54-92e9-ff24.ngrok.io/articles'
...
likedArticle = () => {
    const url = 'http://3a9b-2402-e280-3d6b-7e-3138-6a54-92e9-ff24.ngrok.io/liked'
...
unlikedArticle = () => {
    const url = 'http://3a9b-2402-e280-3d6b-7e-3138-6a54-92e9-ff24.ngrok.io/unliked'
    axios.post(url).then(res => {
        this.getMovie()
    }).catch(e => {console.log(e.meassage)}) 
} 
